...
SUMMARIZE_CONNECTOR_TEXT_BETA_HEADER = (
    os.environ.get("CONNECTOR_TEXT", "") or "summarize-connector-text-2026-03-13"
) if os.environ.get("CONNECTOR_TEXT") else ""

AFK_MODE_BETA_HEADER = (
    os.environ.get("TRANSCRIPT_CLASSIFIER", "") or "afk-mode-2026-01-31"
) if os.environ.get("TRANSCRIPT_CLASSIFIER") else ""
